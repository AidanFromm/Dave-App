...
type MainTab = "psa-lookup" | "sealed" | "inventory";
type InventoryFilter = "all" | "raw" | "graded" | "sealed";
...
// ════════════════════════════════════════════════════════════
// CURRENT INVENTORY TAB (preserved from original)
// ════════════════════════════════════════════════════════════
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b bg-muted/50">
                <th className="px-4 py-3 text-left font-medium text-muted-foreground w-[72px]" />
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          PSA lookup, sealed products, and inventory management
        </p>
      </div>
